...
#define DEFAULT_AP_SSID_NAME "M5 Stick Remote Server"
#define DEFAULT_AP_SSID_PASSWORD "12345"
...
String apSsidPassword = String(DEFAULT_AP_SSID_PASSWORD);
#if defined(HAS_SDCARD)
...
void setupWiFi() {
  ...
  WiFi.softAP(apSsidName, apSsidPassword);
}
